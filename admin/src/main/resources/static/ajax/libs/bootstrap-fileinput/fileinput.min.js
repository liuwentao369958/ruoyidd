...
!function (e) {
    ...
    e.fn.fileinputLocales = {}, e.fn.fileinputThemes = {}, String.prototype.setTokens = function (e) {
        var t, i, a = "" + this;
        for (t in e) {
            e.hasOwnProperty(t) && (i = RegExp("{" + t + "}", "g"), a = a.replace(i, e[t]))
        }
        return a
    ...
    t = {
        ...
        getFileRelativePath: function (e) {
            return (e.newPath || e.relativePath || e.webkitRelativePath || t.getFileName(e) || null) + ""
        },
        ...
        getElapsed: function (i) {
            var a = i, r = "", n = {},
                o = {year: 31536000, month: 2592000, week: 604800, day: 86400, hour: 3600, minute: 60, second: 1};
        ...
        isIE: function (e) {
            var t, i;
            return "Microsoft Internet Explorer" !== navigator.appName ? !1 : 10 === e ? RegExp("msie\\s" + e, "i").test(navigator.userAgent) : (t = document.createElement("div"), t.innerHTML = "<!--[if IE " + e + "]> <i></i> <![endif]-->", i = t.getElementsByTagName("i").length, document.body.appendChild(t), t.parentNode.removeChild(t), i)
        },
        ...
        constructor: i, _cleanup: function () {
            ...
            i.uploadStartTime = t.now(), i.fileManager = {
                ...
                getUploadStats: function (e, a, r) {
                    var n = i.fileManager, o = e ? n.stats[e] && n.stats[e].started || t.now() : i.uploadStartTime,
                        l = (t.now() - o) / 1000,
                ...
                clear: function () {
                    var e = i.fileManager;
                    i.isDuplicateError = !1, i.isPersistentError = !1, e.totalFiles = null, e.totalSize = null, e.uploadedSize = 0, e.stack = {}, e.errors = [], e.filesProcessed = [], e.stats = {}, e.clearImages()
                },
            ...
            if (a.enableResumableUpload) {
                ...
                if (r.chunkSize = parseFloat(r.chunkSize), r.chunkSize <= 0 || isNaN(r.chunkSize)) {
                    return a._log(n.invalidChunkSize, {chunkSize: r.chunkSize}), void (a.enableResumableUpload = !1)
                }
                i = a.resumableManager = {
                    init: function (e, t, n) {
                        ...
                        e.responseJSON && e.responseJSON.error && (o = "" + e.responseJSON.error), l || (i.error = o), r.showErrorLog && a._log(n.ajaxError, {
                            status: e.status,
                            error: o,
                            text: e.responseText || ""
                        })
                        ...
                        for (t = n.addPool(i.id), e = 0; o > e; e++) {
                            i.logs[e] = !(!i.chunksProcessed[i.id] || !i.chunksProcessed[i.id][e]), i.logs[e] || i.pushAjax(e, 0)
                        }
                        ...
                        if (!i.chunksProcessed[u] || !i.chunksProcessed[u][e]) {
                            if (l > r.maxRetries) {
                                return h(g.resumableMaxRetriesReached, {n: r.maxRetries}), void i.setProcessed("error")
                            }
                            var v, w, b, _, C, y,
                            ...
                            v = new FormData, d = o.stack[u], a._setUploadData(v, {
                                ...
                                if (a._isAborted()) {
                                    return void h(g.resumableAborting)
                                }
            ...
            var i, a, r, n, o, l, s, d, c, u, p, f, g, m, h, v, w, b, _, C, y, x, T, P, F, E, k, S, I, A, D, z, j, U, M,
            ...
            i.previewCache = {
                data: {}, init: function () {
                    ...
                    if (!i.previewCache.data || !i.previewCache.data.content) {
                        return 0
                    }
                    if (e) {
            ...
            i.showConsoleLogs && (a && (e = '"' + a + '": ' + e), e = "bootstrap-fileinput: " + e, "object" == typeof t && (e = e.setTokens(t)), window.console && void 0 !== window.console.log ? window.console.log(e) : window.alert(e))
        }, _validate: function () {
            ...
            return o = i.responseJSON && i.responseJSON.error ? "" + i.responseJSON.error : "", l = o ? o : i.responseText, s.cancelling && s.msgUploadAborted && (d = s.msgUploadAborted), s.showAjaxErrorDetails && l && (o ? d = e.trim(o + "") : (l = e.trim(l.replace(/\n\s*\n/g, "\n")), n = l.length ? "<pre>" + l + "</pre>" : "", d += d ? n : l)), d || (d = s.msgAjaxError.replace("{operation}", t)), s.cancelling = !1, r ? "<b>" + r + ": </b>" + d : d
            ...
            for (o = 0; o < s.length; o++) {
                if (n = s[o], a = l.fileTypeSettings[n], r = a(e, i) ? n : "", !t.isEmpty(r)) {
                    return r
                }
            }
            return "other"
            ...
            if (!e || !e.isDefaultPrevented()) {
                if (!a.isAjaxUpload) {
                    return void (n && "submit" !== r.attr("type") && (i = r.closest("form"), i.length && i.trigger("submit"), e.preventDefault()))
                }
            ...
            if (a.hasClass("file-zoom-fullscreen")) {
                t.toggleFullScreen(!1), e ? r.hasClass("active") || (a.removeClass("file-zoom-fullscreen"), i._resizeZoomDialog(!0), n.hasClass("active") && n.removeClass("active").attr("aria-pressed", "false")) : r.hasClass("active") ? r.removeClass("active").attr("aria-pressed", "false") : (a.removeClass("file-zoom-fullscreen"), i.$modal.find(".kv-zoom-body").css("height", i.zoomModalHeight))
            } else {
                if (!e) {
            ...
            }, w._setFileData(C, P.file, E, a), w._setUploadData(C, {fileId: a}), w._ajaxSubmit(p, g, m, h, C, a, i)))
            ...
            var h, v, w, b = this, _ = b.slug(r), C = "", y = "",
                ...
                P = _, F = "type-default", E = u || b._renderFileFooter(i, _, d, "auto", s), k = b.preferIconicPreview,
                S = b.preferIconicZoomPreview, I = k ? "other" : i;
            ...
            }, p = p || o.slice(o.lastIndexOf("-") + 1), b.fileActionSettings.showZoom && (C = w(S ? "other" : i, m ? m : a, !0, "kv-zoom-thumb")), C = "\n" + b._getLayoutTemplate("zoomCache").replace("{zoomContent}", C), "function" == typeof b.sanitizeZoomCache && (C = b.sanitizeZoomCache(C)), h = w(k ? "other" : i, a, !1, "kv-preview-thumb"), h.setTokens({zoomCache: C})
            ...
            return t.isEmpty(e, !0) ? "" : (e + "").replace(/[\[\]\/\{}:;#%=\(\)\*\+\?\\\^\$\|<>&"']/g, "_")
            ...
            if (n.showPreview || o && o.length) {
                ...
                if (n.enableResumableUpload) {
                    ...
                    s.setProgress(i, a), o = c && c.length ? c.find(".file-thumb-progress") : null, n._setProgress(a, o, null, n._getStats(r)), e.each(s.stats, function (e, t) {
                        u += t.loaded
            ...
            c && u || (s = "load.fileinputimageorient", f ? (i = a, a = null, i.css(d.previewSettings.image), l = e(document.createElement("div")).appendTo(n.find(".kv-file-content")), o = e(document.createElement("span")).insertBefore(i), i.css("visibility", "hidden").removeClass("file-zoom-detail").appendTo(l)) : p = !i.is(":visible"), i.off(s).on(s, function () {
                ...
                var e = i[0], s = a && a.length ? a[0] : null, c = e.offsetHeight, u = e.offsetWidth,
                    g = t.getRotation(r);
                if (p && (n.find(".kv-file-content").css("visibility", "visible"), d.$preview.addClass("hide-content")), i.data("orientation", r), s && a.data("orientation", r), 5 > r) {
            ...
            r === i.fileManager.totalImages && (i._raise("fileimagesloaded"), i.resizeImage && e.each(i.fileManager.loadedImages, function (e, o) {
                o.validated || (t = o.siz, t && t > 1000 * n && i._getResizedImage(e, o, a, r), o.validated = !0)
            }))
            ...
            var o, l, s, d, c, u, p, f, g, m, h = this, v = e(a.img)[0], w = v.naturalWidth, b = v.naturalHeight, _ = 1,
                ...
                P = h.imageCanvasContext, F = a.typ, E = a.pid, k = a.ind, S = a.thumb, I = a.exifObj;
            if (c = function (e, t, i) {
                ...
                index: k,
                fileId: i
            }, m = [i, E, k], (!f || !x || C >= w && y >= b) && (x && f && h._raise("fileimageresized", m), r.val++, r.val === n && h._raise("fileimagesresized"), !x)) {
            ...
            if (c.$caption.length) {
                if (c.$captionContainer.removeClass("icon-visible"), a) {
                    r = e("<div>" + c.msgValidationError + "</div>").text(), l = c.fileManager.count(), l ? (d = c.fileManager.getFirstFile(), s = 1 === l && d ? d.nameFmt : c._getMsgSelected(l)) : s = c._getMsgSelected(c.msgNo), n = t.isEmpty(i) ? s : i, o = '<span class="' + c.msgValidationErrorClass + '">' + c.msgValidationErrorIcon + "</span>"
                } else {
                    if (t.isEmpty(i)) {
                        return
                    }
            ...
            var p = this;
            if (!e.type && d && (e.type = "image"), p.enableResumableUpload ? t = !1 : "function" == typeof t && (t = t(e)), "function" == typeof i && (i = i(e)), "function" == typeof a && (a = a(e)), "function" == typeof r && (r = r(e)), "function" == typeof n && (n = n(e)), !(t || i || a || r || n)) {
                return ""
            }
            ...
            if (!a.changeTriggered) {
                ...
                if (a.reader = null, a._resetUpload(), a._hideFileIcon(), a.dropZoneEnabled && a.$container.find(".file-drop-zone ." + a.dropZoneTitleClass).remove(), c || (u = i.target && void 0 === i.target.files ? i.target.value ? [{name: i.target.value.replace(/^.+\\/, "")}] : [] : i.target.files || {}), r = u, t.isEmpty(r) || 0 === r.length) {
            ...
            var i = this;
            if (!(e && i.showPreview && i.$preview && i.$preview.length)) {
                return !1
            }
            var a, r, n, o, l = e.name || "", s = e.type || "", d = (e.size || 0) / 1000, c = i._parseFileType(s, l),
                ...
                w = RegExp("\\.(" + f.join("|") + ")$", "i"), b = RegExp("\\.(" + h.join("|") + ")$", "i");
            ...
            r.fileManager.clearImages(), e.each(i, function (e, t) {
                ...
                if (w >= u) {
                    return r.unlock(), r.duplicateErrors.length && (b = "<li>" + r.duplicateErrors.join("</li><li>") + "</li>", 0 === _.find("ul").length ? t.setHtml(_, r.errorCloseButton + "<ul>" + b + "</ul>") : _.find("ul").append(b), _.fadeIn(r.fadeDelay), r._handler(_.find(".kv-error-close"), "click", function () {
                ...
                r.lock(!0);
                var y, x, T, P, F, E, k, S, I, A, D, z, j = i[w], U = r._getFileId(j), M = c + "-" + U,
                    $ = (p.text, p.image), R = (p.html, r._getFileName(j, "")), O = (j && j.size || 0) / 1000, B = "",
                    L = t.createObjectURL(j), N = 0, Z = "", H = !1, W = 0, q = function () {
                        ...
                        }, r.processDelay), r._raise("fileloaded", [j, M, U, w, n]) && r.isAjaxUpload && C.add(j)
                    };
                if (j) {
                    if (S = C.getId(j), g > 0) {
                        for (x = 0; g > x; x++) {
                            E = f[x], k = r.msgFileTypes[E] || E, Z += 0 === x ? k : ", " + k
                        }
                    }
                    if (R === !1) {
                        return void a(w + 1)
                    ...
                    if (0 === R.length) {
                        return T = r.msgInvalidFileName.replace("{name}", t.htmlEncode(t.getFileName(j), "[unknown]")), void v(T, j, M, w, S)
                    }
                    if (t.isEmpty(m) || (B = RegExp("\\.(" + m.join("|") + ")$", "i")), y = O.toFixed(2), r.isAjaxUpload && C.exists(S) || r._getFrame(M, !0).length) {
                        var V = {id: M, index: w, fileId: S, file: j, files: i};
                        return T = r.msgDuplicateFile.setTokens({
                            name: R,
                            size: y
                        }), void (r.isAjaxUpload ? (r.duplicateErrors.push(T), r.isDuplicateError = !0, r._raise("fileduplicateerror", [j, S, R, y, M, w]), a(w + 1), r._updateFileDetails(u)) : (r._showError(T, V), r.unlock(), u = 0, r._clearFileInput(), r.reset(), r._updateFileDetails(u)))
                    }
                    if (r.maxFileSize > 0 && O > r.maxFileSize) {
                        return T = r.msgSizeTooLarge.setTokens({
                            name: R,
                            size: y,
                    ...
                    if (null !== r.minFileSize && O <= t.getNum(r.minFileSize)) {
                        return T = r.msgSizeTooSmall.setTokens({
                            name: R,
                            size: y,
                    ...
                    if (!t.isEmpty(f) && t.isArray(f)) {
                        for (x = 0; x < f.length; x += 1) {
                            P = f[x], A = p[P], N += A && "function" == typeof A && A(j.type, t.getFileName(j)) ? 1 : 0
                        }
                        if (0 === N) {
                            return T = r.msgInvalidFileType.setTokens({name: R, types: Z}), void v(T, j, M, w, S)
                        }
                    }
                    if (0 === N && !t.isEmpty(m) && t.isArray(m) && !t.isEmpty(B) && (F = t.compare(R, B), N += t.isEmpty(F) ? 0 : F.length, 0 === N)) {
                        return T = r.msgInvalidFileExtension.setTokens({name: R, extensions: h}), void v(T, j, M, w, S)
                    }
                    if (!r._canPreview(j)) {
                        return I = r.isAjaxUpload && r._raise("filebeforeload", [j, w, n]), r.isAjaxUpload && I && C.add(j), r.showPreview && I && (o.addClass("file-thumb-loading"), r._previewDefault(j), r._initFileActions()), void setTimeout(function () {
                            I && r._updateFileDetails(u), a(w + 1), r._raise("fileloaded", [j, M, U, w])
                        }, 10)
                    }
            ...
            var e = this, t = !1, i = e.resumableManager;
            ...
            if (e._raise("filereset")) {
                return e.lastProgress = 0, e._resetPreview(), e.$container.find(".fileinput-filename").text(""), t.addCss(e.$container, "file-input-new"), e.getFrames().length && e.$container.removeClass("file-input-new"), e.clearFileStack(), e._setFileDropZoneTitle(), e.$element
            }
        }, disable: function () {
            ...
            if (r.isAjaxUpload && !r.isDisabled && r._isFileSelectionValid(o)) {
                return r.lastProgress = 0, r._resetUpload(), 0 !== o || l ? (r.cancelling = !1, r._showProgress(), r.lock(), 0 === o && l ? (r._setProgress(2), void r._uploadExtraOnly()) : r.enableResumableUpload ? r.resume() : ((r.uploadAsync || r.enableResumableUpload) && (a = r._getOutData(null), r._raise("filebatchpreupload", [a]), r.fileBatchCompleted = !1, r.uploadCache = [], e.each(r.getFileStack(), function (e) {
